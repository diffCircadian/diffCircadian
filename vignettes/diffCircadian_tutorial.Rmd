...
for (i in 2:nrow(BA11)){
  p_amp <- LR_diff(TOD_young,as.numeric(BA11young[i,-1]),TOD_old,as.numeric(BA11old[i,-1]),type="amplitude")$pvalue
  if(p_amp < 0.05){
...
LR_diff(TOD_young,as.numeric(BA11young[index_amp,-1]),TOD_old,as.numeric(BA11old[index_amp,-1]),type="amplitude") # perform LR differential amplitude test 
```
...
diff_amp_young <- fitSinCurve(TOD_young,as.numeric(BA11young[index_amp,-1]))
...
## diff amp old
plot(TOD_old,as.numeric(BA11old[index_amp,-1]),pch=20,ylab="Expression Value",xlab="Time of Death (TOD)", main="Age Old Group")

diff_amp_old <- fitSinCurve(TOD_old,as.numeric(BA11old[index_amp,-1]))
...
TOD_young <- as.numeric(BA11young[1,-1])
for (i in 2:nrow(BA11)){
  p_phase <- LR_diff(TOD_young,as.numeric(BA11young[i,-1]),TOD_old,as.numeric(BA11old[i,-1]),type="phase")$pvalue
  if(p_phase < 0.05){
    index_phase <- i # index of first gene detected with differential amplitude.
    break
  }
}

LR_diff(TOD_young,as.numeric(BA11young[index_phase,-1]),TOD_old,as.numeric(BA11old[index_phase,-1]),type="phase") # perform LR differential phase test 
```
...
par(mfrow = c(2, 2))
## diff phase young
plot(TOD_young,as.numeric(BA11young[index_phase,-1]),pch=20,ylab="Expression Value",xlab="Time of Death (TOD)", main="Age Young Group")

diff_phase_young <- fitSinCurve(TOD_young,as.numeric(BA11young[index_phase,-1]))
...
## diff phase old
plot(TOD_old,as.numeric(BA11old[index_phase,-1]),pch=20,ylab="Expression Value",xlab="Time of Death (TOD)", main="Age Old Group")

diff_phase_old <- fitSinCurve(TOD_old,as.numeric(BA11old[index_phase,-1]))
...
TOD_young <- as.numeric(BA11young[1,-1])
for (i in 2:nrow(BA11)){
  p_offset <- LR_diff(TOD_young,as.numeric(BA11young[i,-1]),TOD_old,as.numeric(BA11old[i,-1]),type="offset")$pvalue
  if(p_offset < 0.05){
    index_offset <- i # index of first gene detected with differential amplitude.
    break
  }
}

LR_diff(TOD_young,as.numeric(BA11young[index_offset,-1]),TOD_old,as.numeric(BA11old[index_offset,-1]),type="offset") # perform LR differential basal test 
```
...
par(mfrow = c(2, 2))
## diff basal young
plot(TOD_young,as.numeric(BA11young[index_offset,-1]),pch=20,ylab="Expression Value",xlab="Time of Death (TOD)", main="Age Young Group",ylim=c(1.5,5))

diff_offset_young <- fitSinCurve(TOD_young,as.numeric(BA11young[index_offset,-1]))
...
## diff basal old
plot(TOD_old,as.numeric(BA11old[index_offset,-1]),pch=20,ylab="Expression Value",xlab="Time of Death (TOD)", main="Age Old Group",ylim=c(1.5,5))

diff_offset_old <- fitSinCurve(TOD_old,as.numeric(BA11old[index_offset,-1]))
...
TOD_young <- as.numeric(BA11young[1,-1])
for (i in 2:nrow(BA11)){
  p_sigma <- LR_diff(TOD_young,as.numeric(BA11young[i,-1]),TOD_old,as.numeric(BA11old[i,-1]),type="rhythmicity")$pvalue
  if(p_sigma < 0.05){
...
LR_diff(TOD_young,as.numeric(BA11young[index_sigma,-1]),TOD_old,as.numeric(BA11old[index_sigma,-1]),type="rhythmicity") # perform LR differential rhythmicity test 
```
...
plot(TOD_young,as.numeric(BA11young[index_sigma,-1]),pch=20,ylab="Expression Value",xlab="Time of Death (TOD)", main="Age Young Group",ylim = c(1.2,3.5))

diff_sigma_young <- fitSinCurve(TOD_young,as.numeric(BA11young[index_sigma,-1]))
...
plot(TOD_old,as.numeric(BA11old[index_sigma,-1]),pch=20,ylab="Expression Value",xlab="Time of Death (TOD)", main="Age Old Group",ylim = c(1.2,3.5))

diff_sigma_old <- fitSinCurve(TOD_old,as.numeric(BA11old[index_sigma,-1]))
