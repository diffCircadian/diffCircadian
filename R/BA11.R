...
#' BA11
#'
#' @format A data frame with 8325 rows and 293 variables. First row are time of death (TOD) of each subject and rest of rows are gene expression values. First column is gene symbol. For rest of columns, each column represents one individual.
#' 
#' 
