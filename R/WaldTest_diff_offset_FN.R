##' Finite sample Wald test for differential offset.
##'
##' Test differential offset of circadian curve fitting using Wald test
##' @title WaldTest_diff_offset_FN
...
##' WaldTest_diff_offset_FN(tt1, yy1, tt2, yy2)



WaldTest_diff_offset_FN <- function(tt1, yy1, tt2, yy2, period = 24){
  n1 <- length(tt1)
