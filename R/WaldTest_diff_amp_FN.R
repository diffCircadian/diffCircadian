##' Finite sample Wald test for differential amplitude.
##'
##' Test differential amplitude of circadian curve fitting using Wald test
##' @title WaldTest_diff_amp_FN
...
##' WaldTest_diff_amp_FN(tt1, yy1, tt2, yy2)


WaldTest_diff_amp_FN <- function(tt1, yy1, tt2, yy2, period = 24){
  n1 <- length(tt1)
