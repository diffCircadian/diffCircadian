##' Finite sample Likelihood ratio test for differential phase.
##'
##' Test differential phase of circadian curve fitting using likelihood ratio test
##' @title LRTest_diff_phase_FN
...
##' LRTest_diff_phase_FN(tt1, yy1, tt2, yy2)


LRTest_diff_phase_FN <- function(tt1, yy1, tt2, yy2, period = 24){
  n1 <- length(tt1)
