##' Finite sample Wald test for differential sigma2
##'
##' Test differential sigma2 of circadian curve fitting using Wald test
##' @title WaldTest_diff_sigma2_FN
...
##' WaldTest_diff_sigma2_FN(tt1, yy1, tt2, yy2)


WaldTest_diff_sigma2_FN <- function(tt1, yy1, tt2, yy2, period = 24){
  n1 <- length(tt1)
