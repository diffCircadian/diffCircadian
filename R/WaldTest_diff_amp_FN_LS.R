...
##' @title Wald test for detecting differential amplitudes.
...
##' WaldTest_diff_amp_FN_LS(tt1, yy1, tt2, yy2)


WaldTest_diff_amp_FN_LS <- function(tt1, yy1, tt2, yy2, period = 24,type="FN"){
  n1 <- length(tt1)
